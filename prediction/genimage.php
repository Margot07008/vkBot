...
$save = "tmp_bg/bg ". strtolower($num_rand.mt_rand(1,255)) .".png";
imagepng($canvas, $save);
imagedestroy($canvas);
...
$text_f = explode("\n", $text_new3);
$box = imagettfbbox($font_size, 0, $font, $text_new3);
$height1 = $box[1] + $font_size + $margin * 1000;
//2

//Магический цикл х2, который переносит по строчкам
